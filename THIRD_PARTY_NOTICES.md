...
- 現在のずんだもん等の音源共通規約では、政治活動・宗教活動またはそれにつながる利用、特定の個人/団体（国家を含む）への批判・非難・応援目的、情報商材、意図的な虚偽/誤解を招く内容、規約で指定される風俗営業等での利用が禁止されている。
- 上記の音声ライセンス禁止用途はユーザー承認でも突破させず、内容または音声providerを変更するまで自動公開しない。
